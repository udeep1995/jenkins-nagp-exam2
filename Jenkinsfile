pipeline {
    ...
    stages {
            ...
            steps {
                script {
                 git branch: 'prod', credentialsId: 'ac07d748-41ef-4fa8-ab77-5e6e672ef4b7', url: 'https://github.com/udeep1995/jenkins-nagp-exam2.git'
                }                
            }    
        }
        stage('Build') {
        ...
        stage('Artifactory Upload') {
            ...
            steps {
                script {
                    ...
                    rtMaven.tool = 'M3'
                    rtMaven.deployer server: server, releaseRepo: 'helloworld-prod', snapshotRepo: 'helloworld-prod'
            ...
            steps {
                script{
                    if(isUnix()) {
                        ...
                        sh 'docker run --name udeep_helloworld_container -d -p 9060:8080 udeep_helloworld_image'
                    } else {
                        bat '''
                        ...
                        bat 'docker run --name udeep_helloworld_container -d -p 9060:8080 udeep_helloworld_image'
                    }
                }
            }
        }
